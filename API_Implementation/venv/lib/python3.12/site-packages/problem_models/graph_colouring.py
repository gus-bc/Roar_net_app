...
class Problem(ProblemInterface):
    ...
    def from_col(cls, file: TextIO):
        ...
        return cls(int(num_vertices), np.array(edges, dtype=int))
...
if __name__ == '__main__':
    ...
    def main():
        ...
        s1 = tabu_search(problem=p, current_solution=s1, min_tabu_tenure=10, max_tabu_tenure=100, max_iterations=1000000, aspiration_criteria=-10, clean_iter=10000, idle_iterations=100000, metric_logger=logger)
        # s1 = iterated_local_search(p, s1, 1000, perturbation_strength=p.vertex_count//100)
