...
# Note: Both scalartypes.c.verifier_src and arrayprint.py implement strs for numpy
# scalars but for different purposes. scalartypes.c.verifier_src has str/reprs for when
...
def _void_scalar_to_string(x, is_repr=True):
    ...
    scalartypes.c.verifier_src code, and is placed here because it uses the elementwise
