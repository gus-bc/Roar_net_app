...
class TestData(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "crackfortran", "data_stmts.f90")]
...
class TestDataF77(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "crackfortran", "data_common.f")]
...
class TestDataMultiplierF77(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "crackfortran", "data_multiplier.f")]
...
class TestDataWithCommentsF77(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "crackfortran", "data_with_comments.f")]
