...
class TestRenamedFunc(util.F2PyTest):
    sources = [
        util.getpath("tests", "verifier_src", "routines", "funcfortranname.f"),
        util.getpath("tests", "verifier_src", "routines", "funcfortranname.pyf"),
    ]
...
class TestRenamedSubroutine(util.F2PyTest):
    sources = [
        util.getpath("tests", "verifier_src", "routines", "subrout.f"),
        util.getpath("tests", "verifier_src", "routines", "subrout.pyf"),
    ]
    module_name = "subrout"
