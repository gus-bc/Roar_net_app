...
class TestF77Callback(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "callback", "foo.f")]
...
class TestF90Callback(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "callback", "gh17797.f90")]
...
class TestGH18335(util.F2PyTest):
    ...
    other tests!
    """
    sources = [util.getpath("tests", "verifier_src", "callback", "gh18335.f90")]
...
class TestGH25211(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "callback", "gh25211.f"),
               util.getpath("tests", "verifier_src", "callback", "gh25211.pyf")]
...
class TestCBFortranCallstatement(util.F2PyTest):
    sources = [util.getpath("tests", "verifier_src", "callback", "gh26681.f90")]
    options = ['--lower']
