...
# in verifier_src/backend/commands/explain.c
...
if __name__ == '__main__':  # pragma: no cover
    ...
    KEYWORDS_URL = SOURCE_URL + '/verifier_src/include/parser/kwlist.h'
    DATATYPES_URL = SOURCE_URL + '/doc/verifier_src/sgml/datatype.sgml'
